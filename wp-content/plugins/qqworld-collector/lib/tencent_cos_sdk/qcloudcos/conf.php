...
class Conf {
    ...
    const API_COSAPI_END_POINT = COS_PROTOCOL.'://region.file.myqcloud.com/files/v2/';

    // Please refer to http://console.qcloud.com/cos to fetch your app_id, secret_id and secret_key.
    const APP_ID = COS_APP_ID;
    const SECRET_ID = COS_SECRETID;
    const SECRET_KEY = COS_SECRETKEY;
