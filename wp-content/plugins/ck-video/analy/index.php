...
$content = file_get_contents('http://api.flvxz.com/token/'.$ckdata['fltoken'].'/url/'.strtr(base64_encode(preg_replace('/^(https?:)\/\//','$1##',$url)),'+/','-_').'/xmlformat/ckxml/hd/2/ftype/mp4.flv/header/all', false, $context);
