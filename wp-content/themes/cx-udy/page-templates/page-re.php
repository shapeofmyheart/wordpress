        ...
        <div class="reg_mid">
            ...
            <?php if(!empty($error)) echo '<p class="ludou-error">'.$error.'</p>';?>
              ...
              <form name="registerform" method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>" class="ludou-reg">
                    ...
                    <div class="form-group has-feedback">
                        <input type="text" class="form-control" name="user_login" placeholder="用户名(字母+符号)" value="<?php if(!empty($sanitized_user_login)) echo $sanitized_user_login; ?>" data-fv-field="username">
                  <i class="fa fa-user"></i>
              </div>
