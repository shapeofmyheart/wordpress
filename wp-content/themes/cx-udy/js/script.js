...
$('.collect').click(function(){
	...
	if(_this.attr('uid')&&_this.hasClass('collect-no')){
		...
		$.ajax({
			...
			dataType: 'html', 
			url: chenxing.ajax_url, 
			data: 'action=collect&uid=' + uid + '&pid=' + pid + '&act=add', cache: false,
			success: function(){
		...
		_this.attr('uid')&&_this.hasClass('remove-collect')){
		var uid = Number(_this.attr('uid'));
		$.ajax({
			type: 'POST', 
			async: false, 
			...
			dataType: 'html', 
			url: chenxing.ajax_url,
			data: 'action=collect&uid=' + uid + '&pid=' + pid + '&act=remove', cache: false,
			success: function(){
